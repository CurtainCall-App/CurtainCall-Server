...
@Slf4j
public class PartyNotParticipatedException extends AbstractDomainException {

    public PartyNotParticipatedException(final PartyId id, final MemberId memberId) {
